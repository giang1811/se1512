        ...
        <div class="menu-list">
            <form action="UpdateAccount" method="POST" id="form-user" class="form-user">
                <div class="form-group">
                    ...
                    <input id="ten_dang_nhap" class="form-control" name="ten_dang_nhap" type="text" readonly value="${userLogin.getUserName()}">
                    <span class="form-message"></span>
                </div>

                <div class="form-group">
                    <label for="ten_nguoi_dung" class="form-label">Tên người dùng</label>
                    <input id="ten_nguoi_dung" class="form-control" name="ten_nguoi_dung" type="text" value="${userLogin.getPatient().getPatientName()}">
                    <span class="form-message"></span>
                </div>

                <div class="form-group">
                    <label for="loai_tai_khoan" class="form-label">Loại tài khoản</label>
                    <input id=loai_tai_khoan" class="form-control" name="loai_tai_khoan" type="text" readonly value="${userLogin.getType().getTenLoaiTaiKhoan()}">
                    <span class="form-message"></span>
                </div>
