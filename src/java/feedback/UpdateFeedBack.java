...
public class UpdateFeedBack extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String id = request.getParameter("id");
         ...
         Report report = reportDao.get(id1);
          request.setAttribute("report", report);
        RequestDispatcher rt = request.getRequestDispatcher("updatefeedback.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         String content =  request.getParameter("report");
          Hashtable<String, String> my_dict = new Hashtable<>();
           my_dict.put("content", content);
           reportDao.update(report, my_dict);
           List<Report> list = reportDao.getAllById(report.getIdPatient());
